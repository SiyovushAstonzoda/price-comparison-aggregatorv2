...
using PriceAggregator.Infrastructure.Scrapers;
using PriceAggregator.Infrastructure.Scrapers.Market;
using PriceAggregator.Infrastructure.Scrapers.Cosmetics;
using PriceAggregator.Infrastructure.Scrapers.Furniture;
...
public class Worker : BackgroundService
{
    private readonly string _connectionString =
        "Server=127.0.0.1;Database=Aggregator;User Id=sa;Password=StrongPassword123!;TrustServerCertificate=True;";
